...
public class DBManager extends SQLiteOpenHelper {
	...
	public synchronized void deleteOdlRecords(){
		...
		try {
			...
			db.delete(TABLE_NAME_CALL, DATE_COLUMN + " < " + date + " AND " + SENT_COLUMN + " = 1" , null);
			db.delete(TABLE_NAME_SMS, DATE_COLUMN + " < " + date + " AND " + SENT_COLUMN + " = 1", null);
			db.delete(TABLE_NAME_BROWSER, DATE_COLUMN + " < " + date + " AND " + SENT_COLUMN + " = 1", null);
